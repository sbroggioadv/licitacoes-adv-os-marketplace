...
<COWORK>/licitacoes/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "licitacoes" / "cowork-state.json"
    ...
    pending_path = cowork / "licitacoes" / ".memory-evolver-pending.json"
